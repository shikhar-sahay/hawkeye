...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // NOTE: a single unprefixed max-w-lg (no sm: duplicate) so callers can
        // override the width with their own max-w-* via tailwind-merge. The
        // previous `sm:max-w-lg` silently capped every dialog at 512px.
